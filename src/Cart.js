...
import yamaha_pacifier from './Products/yamaha_pacifier.png'
                ...
                <div class="col-lg-12 p-5 bg-white rounded shadow-sm mb-5">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <div class="p-2">
                                <img src={yamaha_pacifier} alt="" width="70" class="img-fluid rounded shadow-sm" />
                                <div class="ms-3 d-inline-block align-middle">
                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">yamaha pacifier</a></h5>
                                </div>
                            </div>
                            </th>
                        ...
                        <tr>
                            <th scope="row">
                            <div class="p-2">
                                <img src={yamaha_fs80c} alt="" width="70" class="img-fluid rounded shadow-sm" />
                                <div class="ms-3 d-inline-block align-middle">
                                <h5 class="mb-0"><a href="#" class="text-dark d-inline-block">yamaha fs80c</a></h5>
                                </div>
                            </div>
                            </th>
                        ...
                        <tr>
                            <th scope="row">
                            <div class="p-2">
                                <img src={yamaha_rsp20} alt="" width="70" class="img-fluid rounded shadow-sm" />
                                <div class="ms-3 d-inline-block align-middle">
                                <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block">yamaha RSP20</a></h5>
                                </div>
                            </div>
                            </th>
                            <td class="align-middle"><strong>$79.00</strong></td>
